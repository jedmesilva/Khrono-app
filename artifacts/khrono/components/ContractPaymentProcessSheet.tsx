  ...
  if (method === "saldo") {
    if (type === "definido") {
      ...
      return {
        ...
        title: "Débito do Saldo Khrono",
        body: hasFunds
          ? `${amt} será debitado agora do seu Saldo Khrono (saldo atual: ${formatCurrency(walletBalance)}) para iniciar o contrato.`
    ...
    return {
      ...
      iconBg: "#e0603015",
      title: "Saldo Khrono",
      body: `O valor será calculado pelo tempo trabalhado e debitado automaticamente do seu Saldo Khrono ao encerrar o contrato.`,
      confirmLabel: "Entendi, enviar contrato",
      requiresPaymentProcessing: false,
    };
  }
...
export function ContractPaymentProcessSheet({
  ...
  const handleConfirm = useCallback(async () => {
    ...
    if (isSaldoDefinido && !hasSufficientBalance) {
      Alert.alert(
        "Saldo insuficiente",
        "Recarregue seu Saldo Khrono ou escolha outro método de pagamento.",
        [{ text: "OK" }]
      );
      return;
    }
