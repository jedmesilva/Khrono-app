...
const styles = StyleSheet.create({
  ...
  serviceNamePill: { flexDirection: "row", alignItems: "center", gap: 8, borderWidth: 1, borderRadius: 20, paddingHorizontal: 14, paddingVertical: 7, alignSelf: "flex-start", marginBottom: 20, maxWidth: "100%" },
  serviceNamePillText: { fontFamily: "Sora_600SemiBold", fontSize: 13 },
