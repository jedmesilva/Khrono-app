    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.metaRow}>
          {firstSkill?.type && (
            <View style={[styles.categoryTag, { backgroundColor: accentBg, borderColor: accentBorder }]}>
        ...
        {skills.length > 0 ? (
          ...
          <View style={[styles.sectionCard, { backgroundColor: colors.card, borderColor: colors.cardBorder }]}>
            <View style={styles.sectionHeader}>
              <View style={[styles.sectionIconBadge, { backgroundColor: colors.surface, borderColor: colors.surfaceBorder }]}>
...
const styles = StyleSheet.create({
  ...
  // Section cards
  sectionCard: { borderWidth: 1, borderRadius: 16, padding: 14, gap: 10 },
  sectionHeader: { flexDirection: "row", alignItems: "center", gap: 8 },
  sectionIconBadge: { width: 28, height: 28, borderRadius: 8, borderWidth: 1, alignItems: "center", justifyContent: "center" },
