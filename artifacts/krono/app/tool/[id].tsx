...
const VERIFY_STATUS = {
  ...
  verified: { label: "Verificado pela Krono", color: GREEN, icon: "check-decagram" as const },
};
              ...
              <VerifiedBadge
                onPress={() =>
                  setDialog({
                    ...
                    message:
                      "Essa ferramenta foi verificada pela equipe Krono com base na documentação enviada.",
                  })
                }
              />
            )}
          ...
          <View style={styles.verifyRow}>
            ...
            <View style={{ flex: 1, gap: 2 }}>
              ...
              <Text style={[styles.verifySub, { color: colors.textMuted }]}>
                {vstatus === "verified"
                  ? "Documentação analisada e aprovada pela equipe Krono"
                  : vstatus === "pending"
